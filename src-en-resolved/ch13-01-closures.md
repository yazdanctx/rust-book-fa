...
<span class="caption">لیستینگ ۱۳-۱: Shirt company giveaway situation</span>
...
<span class="caption">لیستینگ ۱۳-۲: Adding optional type annotations of the parameter and return value types in the closure</span>
...
<span class="caption">لیستینگ ۱۳-۳: Attempting to call a closure whose types are inferred with two different types</span>
...
<span class="caption">لیستینگ ۱۳-۴: Defining and calling a closure that captures an immutable reference</span>
...
<span class="caption">لیستینگ ۱۳-۵: Defining and calling a closure that captures a mutable reference</span>
...
<span class="caption">لیستینگ ۱۳-۶: Using `move` to force the closure for the thread to take ownership of `list`</span>
...
<span class="caption">لیستینگ ۱۳-۷: Using `sort_by_key` to order rectangles by width</span>
...
<span class="caption">لیستینگ ۱۳-۸: Attempting to use an `FnOnce` closure with `sort_by_key`</span>
...
<span class="caption">لیستینگ ۱۳-۹: Using an `FnMut` closure with `sort_by_key` is allowed.</span>
