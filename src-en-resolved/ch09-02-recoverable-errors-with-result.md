...
<span class="caption">لیستینگ ۹-۳: Opening a file</span>
...
<span class="caption">لیستینگ ۹-۴: Using a `match` expression to handle the `Result` variants that might be returned</span>
...
<span class="caption">لیستینگ ۹-۵: Handling different kinds of errors in different ways</span>
...
<span class="caption">لیستینگ ۹-۶: A function that returns errors to the calling code using `match`</span>
...
<span class="caption">لیستینگ ۹-۷: A function that returns errors to the calling code using the `?` operator</span>
...
<span class="caption">لیستینگ ۹-۸: Chaining method calls after the `?` operator</span>
...
<span class="caption">لیستینگ ۹-۹: Using `fs::read_to_string` instead of opening and then reading the file</span>
...
<span class="caption">لیستینگ ۹-۱۰: Attempting to use the `?` in the `main` function that returns `()` won’t compile.</span>
...
<span class="caption">لیستینگ ۹-۱۱: Using the `?` operator on an `Option<T>` value</span>
...
<span class="caption">لیستینگ ۹-۱۲: Changing `main` to return `Result<(), E>` allows the use of the `?` operator on `Result` values.</span>
