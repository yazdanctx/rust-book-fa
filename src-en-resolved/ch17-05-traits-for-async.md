...
<span class="caption">لیستینگ ۱۷-۲۳: Awaiting futures in a collection</span>
...
<span class="caption">لیستینگ ۱۷-۲۴: Pinning the futures to enable moving them into the vector</span>
