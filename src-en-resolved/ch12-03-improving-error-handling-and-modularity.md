...
<span class="caption">لیستینگ ۱۲-۵: Extracting a `parse_config` function from `main`</span>
...
<span class="caption">لیستینگ ۱۲-۶: Refactoring `parse_config` to return an instance of a `Config` struct</span>
...
<span class="caption">لیستینگ ۱۲-۷: Changing `parse_config` into `Config::new`</span>
...
<span class="caption">لیستینگ ۱۲-۸: Adding a check for the number of arguments</span>
...
<span class="caption">لیستینگ ۱۲-۹: Returning a `Result` from `Config::build`</span>
...
<span class="caption">لیستینگ ۱۲-۱۰: Exiting with an error code if building a `Config` fails</span>
...
<span class="caption">لیستینگ ۱۲-۱۱: Extracting a `run` function containing the rest of the program logic</span>
...
<span class="caption">لیستینگ ۱۲-۱۲: Changing the `run` function to return `Result`</span>
...
<span class="caption">لیستینگ ۱۲-۱۳: Defining the `search` function in *src/lib.rs*</span>
...
<span class="caption">لیستینگ ۱۲-۱۴: Using the `minigrep` library crate’s `search` function in *src/main.rs*</span>
