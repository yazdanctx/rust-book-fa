...
<span class="caption">لیستینگ ۸-۲۰: Creating a new hash map and inserting some keys and values</span>
...
<span class="caption">لیستینگ ۸-۲۱: Accessing the score for the Blue team stored in the hash map</span>
...
<span class="caption">لیستینگ ۸-۲۲: Showing that keys and values are owned by the hash map once they’re inserted</span>
...
<span class="caption">لیستینگ ۸-۲۳: Replacing a value stored with a particular key</span>
...
<span class="caption">لیستینگ ۸-۲۴: Using the `entry` method to only insert if the key does not already have a value</span>
...
<span class="caption">لیستینگ ۸-۲۵: Counting occurrences of words using a hash map that stores words and counts</span>
