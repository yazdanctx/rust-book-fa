...
<span class="caption">لیستینگ ۵-۱۳: Defining an `area` method on the `Rectangle` struct</span>
...
<span class="caption">لیستینگ ۵-۱۴: Using the as-yet-unwritten `can_hold` method</span>
...
<span class="caption">لیستینگ ۵-۱۵: Implementing the `can_hold` method on `Rectangle` that takes another `Rectangle` instance as a parameter</span>
...
<span class="caption">لیستینگ ۵-۱۶: Rewriting Listing 5-15 using multiple `impl` blocks</span>
