...
<span class="caption">لیستینگ ۱۹-۱: Using a pattern to destructure a tuple and create three variables at once</span>
...
<span class="caption">لیستینگ ۱۹-۲: Incorrectly constructing a pattern whose variables don’t match the number of elements in the tuple</span>
...
<span class="caption">لیستینگ ۱۹-۳: Mixing `if let`, `else if`, `else if let`, and `else`</span>
...
<span class="caption">لیستینگ ۱۹-۴: Using a `while let` loop to print values for as long as `rx.recv()` returns `Ok`</span>
...
<span class="caption">لیستینگ ۱۹-۵: Using a pattern in a `for` loop to destructure a tuple</span>
...
<span class="caption">لیستینگ ۱۹-۶: A function signature using patterns in the parameters</span>
...
<span class="caption">لیستینگ ۱۹-۷: A function with parameters that destructure a tuple</span>
