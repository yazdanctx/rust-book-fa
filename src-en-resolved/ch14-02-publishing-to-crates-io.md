...
<span class="caption">لیستینگ ۱۴-۱: A documentation comment for a function</span>
...
<span class="caption">لیستینگ ۱۴-۲: The documentation for the `my_crate` crate as a whole</span>
...
<span class="caption">لیستینگ ۱۴-۳: An `art` library with items organized into `kinds` and `utils` modules</span>
...
<span class="caption">لیستینگ ۱۴-۴: A crate using the `art` crate’s items with its internal structure exported</span>
...
<span class="caption">لیستینگ ۱۴-۵: Adding `pub use` statements to re-export items</span>
...
<span class="caption">لیستینگ ۱۴-۶: A program using the re-exported items from the `art` crate</span>
