...
<span class="caption">لیستینگ ۱۸-۱: An `AveragedCollection` struct that maintains a list of integers and the average of the items in the collection</span>
...
<span class="caption">لیستینگ ۱۸-۲: Implementations of the public methods `add`, `remove`, and `average` on `AveragedCollection`</span>
