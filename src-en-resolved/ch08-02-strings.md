...
<span class="caption">لیستینگ ۸-۱۱: Creating a new, empty `String`</span>
...
<span class="caption">لیستینگ ۸-۱۲: Using the `to_string` method to create a `String` from a string literal</span>
...
<span class="caption">لیستینگ ۸-۱۳: Using the `String::from` function to create a `String` from a string literal</span>
...
<span class="caption">لیستینگ ۸-۱۴: Storing greetings in different languages in strings</span>
...
<span class="caption">لیستینگ ۸-۱۵: Appending a string slice to a `String` using the `push_str` method</span>
...
<span class="caption">لیستینگ ۸-۱۶: Using a string slice after appending its contents to a `String`</span>
...
<span class="caption">لیستینگ ۸-۱۷: Adding one character to a `String` value using `push`</span>
...
<span class="caption">لیستینگ ۸-۱۸: Using the `+` operator to combine two `String` values into a new `String` value</span>
...
<span class="caption">لیستینگ ۸-۱۹: Attempting to use indexing syntax with a `String`</span>
