...
<span class="caption">لیستینگ ۱۹-۸: Attempting to use a refutable pattern with `let`</span>
...
<span class="caption">لیستینگ ۱۹-۹: Using `let...else` and a block with refutable patterns instead of `let`</span>
...
<span class="caption">لیستینگ ۱۹-۱۰: Attempting to use an irrefutable pattern with `let...else`</span>
