...
<span class="caption">لیستینگ ۱۳-۱۷: Reproduction of the `Config::build` function from Listing 12-23</span>
...
<span class="caption">لیستینگ ۱۳-۱۸: Passing the return value of `env::args` to `Config::build`</span>
...
<span class="caption">لیستینگ ۱۳-۱۹: Updating the signature of `Config::build` to expect an iterator</span>
...
<span class="caption">لیستینگ ۱۳-۲۰: Changing the body of `Config::build` to use iterator methods</span>
...
<span class="caption">لیستینگ ۱۳-۲۱: The implementation of the `search` function from Listing 12-19</span>
...
<span class="caption">لیستینگ ۱۳-۲۲: Using iterator adapter methods in the implementation of the `search` function</span>
