...
<span class="caption">لیستینگ ۴-۱: A variable and the scope in which it is valid</span>
...
<span class="caption">لیستینگ ۴-۲: Assigning the integer value of variable `x` to `y`</span>
...
<span class="caption">لیستینگ ۴-۳: Functions with ownership and scope annotated</span>
...
<span class="caption">لیستینگ ۴-۴: Transferring ownership of return values</span>
...
<span class="caption">لیستینگ ۴-۵: Returning ownership of parameters</span>
