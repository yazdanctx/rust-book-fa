...
<span class="caption">لیستینگ ۲۰-۳۵: A simplified version of the `vec!` macro definition</span>
...
<span class="caption">لیستینگ ۲۰-۳۶: An example of defining a procedural macro</span>
...
<span class="caption">لیستینگ ۲۰-۳۷: The code a user of our crate will be able to write when using our procedural macro</span>
...
<span class="caption">لیستینگ ۲۰-۳۸: A simple trait that we will use with the `derive` macro</span>
...
<span class="caption">لیستینگ ۲۰-۳۹: How it would look if users wrote a manual implementation of the `HelloMacro` trait</span>
...
<span class="filename">نام فایل: hello_macro_derive/Cargo.toml</span>
...
<span class="caption">لیستینگ ۲۰-۴۰: Code that most procedural macro crates will require in order to process Rust code</span>
...
<span class="caption">لیستینگ ۲۰-۴۱: The `DeriveInput` instance we get when parsing the code that has the macro’s attribute in Listing 20-37</span>
...
<span class="caption">لیستینگ ۲۰-۴۲: Implementing the `HelloMacro` trait using the parsed Rust code</span>
