...
<span class="caption">لیستینگ ۸-۱: Creating a new, empty vector to hold values of type `i32`</span>
...
<span class="caption">لیستینگ ۸-۲: Creating a new vector containing values</span>
...
<span class="caption">لیستینگ ۸-۳: Using the `push` method to add values to a vector</span>
...
<span class="caption">لیستینگ ۸-۴: Using indexing syntax and using the `get` method to access an item in a vector</span>
...
<span class="caption">لیستینگ ۸-۵: Attempting to access the element at index 100 in a vector containing five elements</span>
...
<span class="caption">لیستینگ ۸-۶: Attempting to add an element to a vector while holding a reference to an item</span>
...
<span class="caption">لیستینگ ۸-۷: Printing each element in a vector by iterating over the elements using a `for` loop</span>
...
<span class="caption">لیستینگ ۸-۸: Iterating over mutable references to elements in a vector</span>
...
<span class="caption">لیستینگ ۸-۹: Defining an enum to store values of different types in one vector</span>
...
<span class="caption">لیستینگ ۸-۱۰: Showing where the vector and its elements are dropped</span>
