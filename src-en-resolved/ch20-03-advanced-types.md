...
<span class="caption">لیستینگ ۲۰-۲۵: Using a long type in many places</span>
...
<span class="caption">لیستینگ ۲۰-۲۶: Introducing a type alias, `Thunk`, to reduce repetition</span>
...
<span class="caption">لیستینگ ۲۰-۲۷: A `match` with an arm that ends in `continue`</span>
