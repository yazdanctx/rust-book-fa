...
<span class="caption">لیستینگ ۵-۸: Calculating the area of a rectangle specified by separate width and height variables</span>
...
<span class="caption">لیستینگ ۵-۹: Specifying the width and height of the rectangle with a tuple</span>
...
<span class="caption">لیستینگ ۵-۱۰: Defining a `Rectangle` struct</span>
...
<span class="caption">لیستینگ ۵-۱۱: Attempting to print a `Rectangle` instance</span>
...
<span class="caption">لیستینگ ۵-۱۲: Adding the attribute to derive the `Debug` trait and printing the `Rectangle` instance using debug formatting</span>
