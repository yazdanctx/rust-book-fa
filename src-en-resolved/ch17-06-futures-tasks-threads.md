...
<span class="caption">لیستینگ ۱۷-۲۵: Sending messages with blocking code in a thread and awaiting the messages in an async block</span>
...
[Chapter 21][ch21] will apply these concepts in a more realistic
