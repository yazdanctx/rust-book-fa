...
<span class="caption">لیستینگ ۷-۲۱: Declaring the `front_of_house` module whose body will be in *src/front_of_house.rs*</span>
...
<span class="filename">نام فایل: src/front_of_house.rs</span>
...
<span class="caption">لیستینگ ۷-۲۲: Definitions inside the `front_of_house` module in *src/front_of_house.rs*</span>
...
<span class="filename">نام فایل: src/front_of_house/hosting.rs</span>
