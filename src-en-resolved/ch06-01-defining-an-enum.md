...
<span class="caption">لیستینگ ۶-۱: Storing the data and `IpAddrKind` variant of an IP address using a `struct`</span>
...
<span class="caption">لیستینگ ۶-۲: A `Message` enum whose variants each store different amounts and types of values</span>
