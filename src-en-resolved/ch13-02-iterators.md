...
<span class="caption">لیستینگ ۱۳-۱۰: Creating an iterator</span>
...
<span class="caption">لیستینگ ۱۳-۱۱: Using an iterator in a `for` loop</span>
...
<span class="caption">لیستینگ ۱۳-۱۲: Calling the `next` method on an iterator</span>
...
<span class="caption">لیستینگ ۱۳-۱۳: Calling the `sum` method to get the total of all items in the iterator</span>
...
<span class="caption">لیستینگ ۱۳-۱۴: Calling the iterator adapter `map` to create a new iterator</span>
...
<span class="caption">لیستینگ ۱۳-۱۵: Calling the `map` method to create a new iterator, and then calling the `collect` method to consume the new iterator and create a vector</span>
...
<span class="caption">لیستینگ ۱۳-۱۶: Using the `filter` method with a closure that captures `shoe_size`</span>
