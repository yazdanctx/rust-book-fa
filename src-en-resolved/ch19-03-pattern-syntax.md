...
<span class="caption">لیستینگ ۱۹-۱۱: A `match` expression with an arm that introduces a new variable which shadows an existing variable `y`</span>
...
<span class="caption">لیستینگ ۱۹-۱۲: Destructuring a struct’s fields into separate variables</span>
...
<span class="caption">لیستینگ ۱۹-۱۳: Destructuring struct fields using struct field shorthand</span>
...
<span class="caption">لیستینگ ۱۹-۱۴: Destructuring and matching literal values in one pattern</span>
...
<span class="caption">لیستینگ ۱۹-۱۵: Destructuring enum variants that hold different kinds of values</span>
...
<span class="caption">لیستینگ ۱۹-۱۶: Matching on nested enums</span>
...
<span class="caption">لیستینگ ۱۹-۱۷: Using `_` in a function signature</span>
...
<span class="caption">لیستینگ ۱۹-۱۸: Using an underscore within patterns that match `Some` variants when we don’t need to use the value inside the `Some`</span>
...
<span class="caption">لیستینگ ۱۹-۱۹: Ignoring multiple parts of a tuple</span>
...
<span class="caption">لیستینگ ۱۹-۲۰: Starting a variable name with an underscore to avoid getting unused variable warnings</span>
...
<span class="caption">لیستینگ ۱۹-۲۱: An unused variable starting with an underscore still binds the value, which might take ownership of the value.</span>
...
<span class="caption">لیستینگ ۱۹-۲۲: Using an underscore does not bind the value.</span>
...
<span class="caption">لیستینگ ۱۹-۲۳: Ignoring all fields of a `Point` except for `x` by using `..`</span>
...
<span class="caption">لیستینگ ۱۹-۲۴: Matching only the first and last values in a tuple and ignoring all other values</span>
...
<span class="caption">لیستینگ ۱۹-۲۵: An attempt to use `..` in an ambiguous way</span>
...
<span class="caption">لیستینگ ۱۹-۲۶: Adding a match guard to a pattern</span>
...
<span class="caption">لیستینگ ۱۹-۲۷: Using a match guard to test for equality with an outer variable</span>
...
<span class="caption">لیستینگ ۱۹-۲۸: Combining multiple patterns with a match guard</span>
...
<span class="caption">لیستینگ ۱۹-۲۹: Using `@` to bind to a value in a pattern while also testing it</span>
