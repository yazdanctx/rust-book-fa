...
<span class="caption">لیستینگ ۱۲-۱: Collecting the command line arguments into a vector and printing them</span>
...
<span class="caption">لیستینگ ۱۲-۲: Creating variables to hold the query argument and file path argument</span>
