...
<span class="caption">لیستینگ ۲-۱: Code that gets a guess from the user and prints it</span>
...
<span class="caption">لیستینگ ۲-۲: The output from running `cargo build` after adding the `rand` crate as a dependency</span>
...
<span class="caption">لیستینگ ۲-۳: Adding code to generate a random number</span>
...
<span class="caption">لیستینگ ۲-۴: Handling the possible return values of comparing two numbers</span>
...
<span class="caption">لیستینگ ۲-۵: Ignoring a non-number guess and asking for another guess instead of crashing the program</span>
...
<span class="caption">لیستینگ ۲-۶: Complete guessing game code</span>
