...
<span class="caption">لیستینگ ۷-۱۱: Bringing a module into scope with `use`</span>
...
<span class="caption">لیستینگ ۷-۱۲: A `use` statement only applies in the scope it’s in.</span>
...
<span class="caption">لیستینگ ۷-۱۳: Bringing the `add_to_waitlist` function into scope with `use`, which is unidiomatic</span>
...
<span class="caption">لیستینگ ۷-۱۴: Bringing `HashMap` into scope in an idiomatic way</span>
...
<span class="caption">لیستینگ ۷-۱۵: Bringing two types with the same name into the same scope requires using their parent modules.</span>
...
<span class="caption">لیستینگ ۷-۱۶: Renaming a type when it’s brought into scope with the `as` keyword</span>
...
<span class="caption">لیستینگ ۷-۱۷: Making a name available for any code to use from a new scope with `pub use`</span>
...
Number”][rand] in Chapter 2, we brought items in the
...
<span class="caption">لیستینگ ۷-۱۸: Specifying a nested path to bring multiple items with the same prefix into scope</span>
...
<span class="caption">لیستینگ ۷-۱۹: Two `use` statements where one is a subpath of the other</span>
...
<span class="caption">لیستینگ ۷-۲۰: Combining the paths in Listing 7-19 into one `use` statement</span>
