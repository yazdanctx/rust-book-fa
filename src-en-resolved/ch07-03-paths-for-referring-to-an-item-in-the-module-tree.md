...
<span class="caption">لیستینگ ۷-۳: Calling the `add_to_waitlist` function using absolute and relative paths</span>
...
<span class="caption">لیستینگ ۷-۴: Compiler errors from building the code in Listing 7-3</span>
...
<span class="caption">لیستینگ ۷-۵: Declaring the `hosting` module as `pub` to use it from `eat_at_restaurant`</span>
...
<span class="caption">لیستینگ ۷-۶: Compiler errors from building the code in Listing 7-5</span>
...
<span class="caption">لیستینگ ۷-۷: Adding the `pub` keyword to `mod hosting` and `fn add_to_waitlist` lets us call the function from `eat_at_restaurant`.</span>
...
<span class="caption">لیستینگ ۷-۸: Calling a function using a relative path starting with `super`</span>
...
<span class="caption">لیستینگ ۷-۹: A struct with some public fields and some private fields</span>
...
<span class="caption">لیستینگ ۷-۱۰: Designating an enum as public makes all its variants public.</span>
