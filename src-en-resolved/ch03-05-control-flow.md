...
<span class="caption">لیستینگ ۳-۲: Assigning the result of an `if` expression to a variable</span>
...
<span class="caption">لیستینگ ۳-۳: Using a `while` loop to run code while a condition evaluates to `true`</span>
...
<span class="caption">لیستینگ ۳-۴: Looping through each element of a collection using a `while` loop</span>
...
<span class="caption">لیستینگ ۳-۵: Looping through each element of a collection using a `for` loop</span>
