...
<span class="filename">نام فایل: poem.txt</span>
...
<span class="caption">لیستینگ ۱۲-۳: A poem by Emily Dickinson makes a good test case.</span>
...
<span class="caption">لیستینگ ۱۲-۴: Reading the contents of the file specified by the second argument</span>
