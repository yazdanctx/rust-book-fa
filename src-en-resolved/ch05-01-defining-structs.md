...
<span class="caption">لیستینگ ۵-۱: A `User` struct definition</span>
...
<span class="caption">لیستینگ ۵-۲: Creating an instance of the `User` struct</span>
...
<span class="caption">لیستینگ ۵-۳: Changing the value in the `email` field of a `User` instance</span>
...
<span class="caption">لیستینگ ۵-۴: A `build_user` function that takes an email and username and returns a `User` instance</span>
...
<span class="caption">لیستینگ ۵-۵: A `build_user` function that uses field init shorthand because the `username` and `email` parameters have the same name as struct fields</span>
...
<span class="caption">لیستینگ ۵-۶: Creating a new `User` instance using all but one of the values from `user1`</span>
...
<span class="caption">لیستینگ ۵-۷: Using struct update syntax to set a new `email` value for a `User` instance but to use the rest of the values from `user1`</span>
