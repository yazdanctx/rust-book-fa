...
<span class="caption">لیستینگ ۱۶-۶: Creating a channel and assigning the two halves to `tx` and `rx`</span>
...
<span class="caption">لیستینگ ۱۶-۹: Attempting to use `val` after we’ve sent it down the channel</span>
...
<span class="caption">لیستینگ ۱۶-۱۰: Sending multiple messages and pausing between each one</span>
...
<span class="caption">لیستینگ ۱۶-۱۱: Sending multiple messages from multiple producers</span>
